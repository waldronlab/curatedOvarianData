...
@
\caption{The database confirms CXCL12 as prognostic of overall survival in patients
...
outcome.  This plot is Figure 3 of the curatedOvarianData manuscript. }
